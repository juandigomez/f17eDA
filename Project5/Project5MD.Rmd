...
```{r}
diagnosis1=lda(diagnosis~radius_mean+perimeter_mean+area_mean+compactness_mean+concavity_mean,data=interactivedf,prior=c(1,1)/2,subset=train1)
lda.pred=predict(diagnosis1, interactivedf[-train1, ])
...
table(lda.pred$class,interactivedf[-train1, ]$diagnosis)
mean(lda.pred$class==interactivedf[-train1, ]$diagnosis)
```
