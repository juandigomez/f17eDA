---
title: "Fall 2017 Group 8 Project 2 Notebook"
author: "Jackie Lee, Juan Gomez, Patrick Lyons, Ross Miglin"
resource_files:
- .Renviron
output:
  html_notebook:
...
df <- data.world::query(data.world::qry_sql("SELECT * FROM Heart Disease V2"), dataset = project)
