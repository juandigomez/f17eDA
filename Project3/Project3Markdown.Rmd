...
#we first created a glm.fit using total_pupulation, votes, bachelors, and unemployment to predict candidate
...
```
And finally, we identified the greatest predictor of candidate, the bachelors_degree, evidenced by the highest mean value.
```{r}
